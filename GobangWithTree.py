...
def negamax(is_ai, depth, alpha, beta):   #negamax(True,2,-999999,+999999)
    # 游戏是否结束 | | 探索的递归深度是否到边界
...
def evaluation(is_ai):
    ...
    for pt in enemy_list:
        m = pt[0]
        n = pt[1]
        enemy_score += cal_score(m, n, 0, 1, my_list, enemy_list, score_all_arr_enemy) ##cal_score(m, n, x_direction, y_direction, enemy_list, my_list, score_all_arr)
...
def gobangwin():
    ...
    win.setBackground("silver")   #棋盘背景颜色
    i1 = 0
